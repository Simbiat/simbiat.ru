CREATE TABLE IF NOT EXISTS `seo__pageviews` (
  `page` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_nopad_as_ci NOT NULL COMMENT 'Page URL',
  `referer` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_nopad_as_ci NOT NULL COMMENT 'Value of Referer HTTP header',
  ...
  KEY `ip` (`ip`),
  KEY `referer` (`referer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_nopad_as_cs ROW_FORMAT=DYNAMIC COMMENT='Views statistics per page' `PAGE_COMPRESSED`='ON';