CREATE TABLE `cron__schedule` (
  ...
  `dayofweek` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_nopad_ci DEFAULT NULL COMMENT 'Optional limit to run only on specific days of the week. Expects array of integers in JSON string.',
  `priority` tinyint(3) unsigned NOT NULL DEFAULT 0 COMMENT 'Priority of the task',
  `message` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_nopad_ci DEFAULT NULL COMMENT 'Optional message, that will be shown if launched outside of CLI',
  `status` tinyint(1) unsigned NOT NULL DEFAULT 0 COMMENT 'Flag showing whether the task is running or not',
  `runby` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_nopad_ci DEFAULT NULL COMMENT 'If not NULL, indicates, that a task is queued for a run by a process.',
