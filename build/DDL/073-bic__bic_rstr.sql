...
CREATE TABLE IF NOT EXISTS `bic__bic_rstr` (
  ...
  `Rstr` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci NOT NULL COMMENT 'Код ограничения, наложенного на участника',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_cs ROW_FORMAT=DYNAMIC COMMENT='Список ограничений наложенных на участника' `PAGE_COMPRESSED`='ON';