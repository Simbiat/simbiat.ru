...
CREATE TABLE IF NOT EXISTS `maintainer__columns_include` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_cs COMMENT='Additional columns to include from histogram generation' `PAGE_COMPRESSED`='ON' ROW_FORMAT=Dynamic;