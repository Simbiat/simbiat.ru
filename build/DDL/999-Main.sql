...
INSERT INTO `sys__languages` (`tag`, `name`) VALUES
('af', 'Afrikaans'),
...
INSERT INTO `talks__alt_link_types` (`type`, `icon`, `regex`) VALUES
...
INSERT INTO `uc__bad_names` (`name`, `added`, `reason`) VALUES ('Anonymous', current_timestamp(6), NULL);
UPDATE `talks__sections` SET `name`='simbiat.eu' WHERE `name`='simbiat.dev';
UPDATE `talks__sections` SET `description` = 'Personal blog of the owner of this very website' WHERE `talks__sections`.`section_id` = 6;
UPDATE `talks__sections` SET `description` = 'Help articles related to this very website' WHERE `talks__sections`.`section_id` = 8;
INSERT INTO `talks__sections` (`section_id`, `name`, `description`, `parent_id`, `sequence`, `type`, `system`, `closed`, `private`, `created`, `author`, `updated`, `editor`, `icon`) VALUES (NULL, 'simbiat.eu', 'Support tickets for this very website', '5', '99', '5', '1', NULL, '0', current_timestamp(6), '2', current_timestamp(6), '2', 'd073ac38d95227a3fffe0c9da4939ff394e5907419a8842a71fb4fab83318a03394d59ea34db1cc8548dbb4cfcea1d28bf7afc71dc54daedf2c3fff12432ddac');
...
INSERT INTO `cron__tasks` (`task`, `function`, `object`, `parameters`, `allowed_returns`, `max_time`, `min_frequency`, `retry`, `enabled`, `system`, `description`) VALUES ('foreign_keys_clean', 'cleanForeignKeys', '\\Simbiat\\Website\\Cron\\Maintenance', NULL, NULL, '3600', '60', '0', '1', '1', 'Remove entries that would violate foreign key restrictions, if they were used.');
INSERT INTO `cron__schedule` (`task`, `arguments`, `instance`, `enabled`, `system`, `frequency`, `day_of_month`, `day_of_week`, `priority`, `message`, `status`, `run_by`, `sse`, `registered`, `updated`, `next_run`, `last_run`, `last_success`, `last_error`) VALUES ('foreign_keys_clean', '', '1', '1', '1', '2592000', NULL, NULL, '0', 'Cleaning foreign key violations', '0', NULL, '0', current_timestamp(6), current_timestamp(6), current_timestamp(6), NULL, NULL, NULL);
INSERT INTO `cron__tasks` (`task`, `function`, `object`, `parameters`, `allowed_returns`, `max_time`, `min_frequency`, `retry`, `enabled`, `system`, `description`) VALUES ('empty_threads', 'removeEmptyThreads', '\\Simbiat\\Website\\Cron\\Maintenance', NULL, NULL, '3600', '60', '0', '1', '1', 'Remove empty threads older than 1 day'), ('dead_links', 'removeDeadLinks', '\\Simbiat\\Website\\Cron\\Maintenance', NULL, NULL, '3600', '60', '0', '1', '1', 'Remove alt links that no longer exist');
UPDATE `cron__schedule` SET `next_run` = '2026-01-01 22:00:00.000000' WHERE `cron__schedule`.`task` = 'foreign_keys_clean' AND `cron__schedule`.`arguments` = '' AND `cron__schedule`.`instance` = 1;
INSERT INTO `cron__schedule` (`task`, `arguments`, `instance`, `enabled`, `system`, `frequency`, `day_of_month`, `day_of_week`, `priority`, `message`, `status`, `run_by`, `sse`, `registered`, `updated`, `next_run`, `last_run`, `last_success`, `last_error`) VALUES ('empty_threads', '', '1', '1', '1', '86400', NULL, NULL, '0', 'Cleaning empty threads', '0', NULL, '0', current_timestamp(6), current_timestamp(6), '2026-01-01 20:00:00.000000', NULL, NULL, NULL), ('dead_links', '', '1', '1', '1', '86400', NULL, NULL, '0', 'Checking for dead links', '0', NULL, '0', current_timestamp(6), current_timestamp(6), '2026-01-01 20:00:00.000000', NULL, NULL, NULL);
INSERT INTO `cron__tasks` (`task`, `function`, `object`, `parameters`, `allowed_returns`, `max_time`, `min_frequency`, `retry`, `enabled`, `system`, `description`) VALUES ('clean_notifications', 'cleanNotifications', '\\Simbiat\\Website\\Cron\\Maintenance', NULL, NULL, '3600', '60', '0', '1', '1', 'Remove old notifications');
INSERT INTO `cron__schedule` (`task`, `arguments`, `instance`, `enabled`, `system`, `frequency`, `day_of_month`, `day_of_week`, `priority`, `message`, `status`, `run_by`, `sse`, `registered`, `updated`, `next_run`, `last_run`, `last_success`, `last_error`) VALUES ('clean_notifications', '', '1', '1', '1', '86400', NULL, NULL, '0', 'Removing old notifications', '0', NULL, '0', current_timestamp(6), current_timestamp(6), '2026-01-01 14:00:00.000000', NULL, NULL, NULL);
