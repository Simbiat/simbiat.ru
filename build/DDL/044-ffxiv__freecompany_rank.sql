...
CREATE TABLE IF NOT EXISTS `ffxiv__freecompany_rank` (
  ...
  `rankname` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_nopad_ai_ci NOT NULL COMMENT 'Name of the rank as reported by Lodestone',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_nopad_as_cs ROW_FORMAT=DYNAMIC COMMENT='Rank names used by companies' `PAGE_COMPRESSED`='ON';