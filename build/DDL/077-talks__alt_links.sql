...
CREATE TABLE IF NOT EXISTS `talks__alt_links` (
  ...
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_nopad_as_ci NOT NULL COMMENT 'Respective alternative URL',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_nopad_as_cs COMMENT='Alternative representation of the threads on other websites' `PAGE_COMPRESSED`='ON' ROW_FORMAT=Dynamic;