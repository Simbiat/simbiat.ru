...
CREATE TABLE IF NOT EXISTS `bic__accounts` (
  ...
  `CK` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Контрольный ключ',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_cs ROW_FORMAT=DYNAMIC COMMENT='Список счетов' `PAGE_COMPRESSED`='ON';