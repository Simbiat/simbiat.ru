...
CREATE TABLE IF NOT EXISTS `talks__posts` (
  ...
  `published` datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'When the post was published',
  ...
  KEY `published_desc` (`published` DESC),
  KEY `published_asc` (`published`),
