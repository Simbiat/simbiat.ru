...
CREATE TABLE IF NOT EXISTS `ffxiv__freecompany` (
  ...
  `formed` datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'Free Company formation day as seen on Lodestone',
  `registered` datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'When Free Company was initially added to tracker',
  ...
  `deleted` datetime(6) DEFAULT NULL COMMENT 'Date when Free Company was marked as deleted',
