...
CREATE TABLE IF NOT EXISTS `bic__swift` (
  ...
  `SWBIC` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci NOT NULL COMMENT 'Банковский идентификационный код, присвоенный SWIFT',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_cs ROW_FORMAT=DYNAMIC COMMENT='Коды SWIFT' `PAGE_COMPRESSED`='ON';