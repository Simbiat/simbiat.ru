...
/* about/resume.twig */
class __TwigTemplate_8f307a1bd24eb3ca1d6973f907b92b8b extends Template
{
    private $source;
    private $macros = [];
...
<section>
    ...
    <p>Don't believe it? Check my <a href=\"/static/resume/Smartly/AnnualReview.pdf\" download><img loading=\"lazy\" decoding=\"async\" class=\"linkIcon\" src=\"/img/icons/PDF.svg\" alt=\"Annual Review\">annual performance 360 review</a>, as well as commentary from some of my colleagues:</p>
    ";
        // line 13
        echo twig_include($this->env, $context, "common/elements/carousel.twig", ["images" => ($context["feedbacks"] ?? null)], true);
        echo "
    <h2>Languages</h2>
    <ul class=\"zeroMargin tagList\">
        ...
        <li><img loading=\"lazy\" decoding=\"async\" class=\"linkIcon\" src=\"/img/flags/Finland.svg\" alt=\"Finnish\">Finnish (in process of upgrading A0)</li>
        <li><img loading=\"lazy\" decoding=\"async\" class=\"linkIcon\" src=\"/img/flags/Germany.svg\" alt=\"German\">German (can read very basic stuff)</li>
    </ul>
