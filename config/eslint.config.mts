...
// Need to use Config assertion to fix false positive https://youtrack.jetbrains.com/issue/WEB-73749/False-positive-argument-not-assignable-for-ESLint-config
export default defineConfig([
    // List of globally ignored files
    {
        ignores: ['./build/js/dev/types/*', './build/js/dev/ESLintPlugin/dist/*', './build/js/dev/StylelintPlugin/dist/*'],
    },
    js_files_config as Config[],
    ts_files_config as Config[],
    markdown_config as Config[],
    json_config,
    jsonc_config,
    json5_config,
    html_files as Config[],
    template_email as Config[],
    package_json_config as Config[],
]);
