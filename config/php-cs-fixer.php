...
return new Config()
    ...
    ->setCacheFile('/app/data/temp/.php-cs-fixer.cache')
    ->setRules([
                   '@auto' => true,
                   '@auto:risky' => true,
                   '@PhpCsFixer' => true,
                   ...
                   // False-positives with some constructs (like phpcs:disable) and with descriptions that are multiple sentences.
