...
(
    ...
    `server`     VARCHAR(20) COLLATE utf8mb4_uca1400_nopad_as_ci NOT NULL COMMENT 'Server name',
    `datacenter` VARCHAR(10) COLLATE utf8mb4_uca1400_nopad_as_ci NOT NULL COMMENT 'Data center name',
