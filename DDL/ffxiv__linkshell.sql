...
(
    `linkshellid` VARCHAR(40) COLLATE utf8mb4_uca1400_nopad_as_ci  NOT NULL COMMENT 'Linkshell ID taken from Lodestone URL (https://eu.finalfantasyxiv.com/lodestone/linkshell/linkshellid/ or https://eu.finalfantasyxiv.com/lodestone/crossworld_linkshell/linkshellid/)' PRIMARY KEY,
    `name`        VARCHAR(50) COLLATE utf8mb4_uca1400_nopad_ai_ci  NOT NULL COMMENT 'Linkshell name',
    ...
    `updated`     DATETIME(6)         DEFAULT CURRENT_TIMESTAMP(6) NOT NULL ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'When Linkshsell was last updated on the tracker',
