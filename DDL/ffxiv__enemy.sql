...
) ENGINE=InnoDB AUTO_INCREMENT=326 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_nopad_as_cs COMMENT='List of some monsters, that are used for character ''deaths'', when they are marked as deleted' `PAGE_COMPRESSED`='ON' ROW_FORMAT=Dynamic;