...
(
    `pvpteamid`    VARCHAR(40)                                     NOT NULL COMMENT 'PvP Team ID taken from Lodestone URL (https://eu.finalfantasyxiv.com/lodestone/pvpteam/pvpteamid/)' PRIMARY KEY,
...
) COMMENT 'PvP Teams found on Lodestone' ENGINE = `InnoDB` `PAGE_COMPRESSED` = 'ON' ROW_FORMAT = DYNAMIC;
