CREATE TABLE `ffxiv__linkshell_rank` (
  ...
  KEY `lsrank` (`rank`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_nopad_as_cs ROW_FORMAT=DYNAMIC COMMENT='Rank names used by linkshells' `PAGE_COMPRESSED`='ON';