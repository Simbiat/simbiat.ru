...
(
    ...
    `registered`  DATETIME(6)         DEFAULT CURRENT_TIMESTAMP(6) NOT NULL COMMENT 'When the job was initially registered',
    `updated`     DATETIME(6)         DEFAULT CURRENT_TIMESTAMP(6) NOT NULL COMMENT 'When the job schedule was updated',
    `nextrun`     DATETIME(6)         DEFAULT CURRENT_TIMESTAMP(6) NOT NULL COMMENT 'Next expected time for the job to be run',
