...
(
    ...
    `userid`    INT UNSIGNED                                NULL COMMENT 'ID of the uploader',
    ...
    CONSTRAINT `file_to_user` FOREIGN KEY (`userid`) REFERENCES `uc__users` (`userid`) ON UPDATE CASCADE ON DELETE SET NULL
