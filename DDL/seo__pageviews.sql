...
(
    `page`    VARCHAR(256) COLLATE utf8mb4_uca1400_nopad_as_ci NOT NULL COMMENT 'Page URL',
    `referer` VARCHAR(256) COLLATE utf8mb4_uca1400_nopad_as_ci NOT NULL COMMENT 'Value of Referer HTTP header',
