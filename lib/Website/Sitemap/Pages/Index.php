...
class Index extends Page
{
    ...
    protected string $query = '
                    ...
                    UNION ALL
                    SELECT \'users\' AS `link`, \'Users\' AS `name`, COUNT(*) AS `count` FROM `uc__users` WHERE `userid` NOT IN ('.\Simbiat\Website\Config::userIDs['Unknown user'].', '.\Simbiat\Website\Config::userIDs['System user'].', '.\Simbiat\Website\Config::userIDs['Deleted user'].')
                    UNION ALL
