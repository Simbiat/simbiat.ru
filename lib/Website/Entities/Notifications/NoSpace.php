...
/**
 * Warning about server running out of space
 */
final class NoSpace extends Notification
{
    /**
     * Subject for email
     */
    ...
    protected function setText(array $twig_vars = []): self
    {
        ...
        try {
            $this->text = EnvironmentGenerator::getTwig()->render('notifications/no_space.twig', $twig_vars);
