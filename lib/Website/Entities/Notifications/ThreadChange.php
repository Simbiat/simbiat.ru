...
/**
 * Notifications about changes to threads for thread authors
 */
final class ThreadChange extends Notification
{
    /**
     * Subject for email
     */
    ...
    {
        try {
            $this->text = EnvironmentGenerator::getTwig()->render('notifications/thread_change.twig', $twig_vars);
