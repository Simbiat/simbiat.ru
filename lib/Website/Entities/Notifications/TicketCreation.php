...
/**
 * Confirmation about ticket being created for anonymous users
 */
final class TicketCreation extends Notification
{
    /**
     * Subject for email
     */
    protected const string SUBJECT = 'Ticket created';
    /**
    ...
    protected function setText(array $twig_vars = []): self
    {
        ...
        try {
            $this->text = EnvironmentGenerator::getTwig()->render('notifications/ticket_creation.twig', $twig_vars);
