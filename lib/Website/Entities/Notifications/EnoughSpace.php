...
/**
 * Confirmation, that enough space is now available
 */
final class EnoughSpace extends Notification
{
    /**
     * Subject for email
     */
    protected const string SUBJECT = '[Resolved]: Low space';
    /**
    ...
    protected function setText(array $twig_vars = []): self
    {
        ...
        try {
            $this->text = EnvironmentGenerator::getTwig()->render('notifications/enough_space.twig', $twig_vars);
