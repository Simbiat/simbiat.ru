...
/**
 * Notification about database going down
 */
final class DatabaseDown extends Notification
{
    /**
     * Subject for email
     */
    ...
    protected function setText(array $twig_vars = []): self
    {
        ...
        try {
            $this->text = EnvironmentGenerator::getTwig()->render('notifications/database_down.twig', $twig_vars);
