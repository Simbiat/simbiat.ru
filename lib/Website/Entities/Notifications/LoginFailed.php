...
/**
 * Notification about failed login
 */
final class LoginFailed extends Notification
{
    /**
     * Subject for email
     */
    ...
    {
        try {
            $this->text = EnvironmentGenerator::getTwig()->render('notifications/login_failed.twig', $twig_vars);
