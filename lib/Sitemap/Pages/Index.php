...
class Index extends Page
{
    ...
    protected string $query = '
                    ...
                    UNION ALL
                    SELECT \'users\' AS `link`, \'Users\' AS `name`, COUNT(*) AS `count` FROM `uc__users` WHERE `userid` NOT IN ('.\Simbiat\Config::userIDs['Unknown user'].', '.\Simbiat\Config::userIDs['System user'].', '.\Simbiat\Config::userIDs['Deleted user'].')
                    UNION ALL
