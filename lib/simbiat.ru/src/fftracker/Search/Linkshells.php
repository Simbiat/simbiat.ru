...
class Linkshells extends Search
{
    ...
    #List of fields
    protected string $fields = '`linkshellid` as `id`, `name`, `crossworld`';
    #Optional WHERE clause
    protected string $where = '';
    #Condition for search
    protected string $whatToSearch = 'IF(`linkshellid` = :what, 99999, MATCH (`name`) AGAINST (:match IN BOOLEAN MODE))';
