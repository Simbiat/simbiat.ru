...
class Section extends Entity
{
    ...
    protected function getFromDB(): array
    {
        ...
        if ($this->id === 'top') {
            $data = [
                ...
                'closed' => 'now',
                'created' => null,
                'createdby' => \Simbiat\Config::userIDs['Owner'],
                'updated' => null,
                'updatedby' => \Simbiat\Config::userIDs['Owner'],
    ...
    protected function process(array $fromDB): void
    {
        ...
        $this->createdBy = $fromDB['createdby'] ?? \Simbiat\Config::userIDs['Deleted user'];
        $this->updated = $fromDB['updated'] !== null ? strtotime($fromDB['updated']) : null;
        $this->updatedBy = $fromDB['updatedby'] ?? \Simbiat\Config::userIDs['Deleted user'];
