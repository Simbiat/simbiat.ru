...
class MainRouter extends Abstracts\Router
{
    ...
    protected function pageGen(array $path): array
    {
        ...
        return match($path[0]) {
            ...
            'bic' => (new bictracker\Redirects\Legacy)->get(array_slice($path, 1)),
    ...
    private function error(array $uri): array {
        if (empty($uri[0]) || !in_array((int)$uri[0], [300, 301, 302, 303, 305, 307, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416, 417, 418, 500, 501, 502, 503, 504, 505])) {
