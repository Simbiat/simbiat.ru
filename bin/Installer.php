...
if (new Installer()->install()) {
    ...
    new TaskInstance()->settingsFromArray(['task' => 'ff_update_statistics', 'instance' => 1, 'enabled' => 1, 'system' => 1, 'frequency' => 86400, 'priority' => 2, 'message' => 'Updating FFXIV statistics', 'next_run' => strtotime('today 4:00')])->add();
