...
if (new Installer()->install()) {
    ...
    new TaskInstance()->settingsFromArray(['task' => 'ffUpdateOld', 'arguments' => '[50, "$cronInstance"]', 'instance' => 1, 'enabled' => 1, 'system' => 1, 'frequency' => 60, 'priority' => 0, 'message' => 'Updating old FFXIV entities', 'next_run' => time()])->add();
    new TaskInstance()->settingsFromArray(['task' => 'ffUpdateOld', 'arguments' => '[50, "$cronInstance"]', 'instance' => 2, 'enabled' => 1, 'system' => 1, 'frequency' => 60, 'priority' => 0, 'message' => 'Updating old FFXIV entities', 'next_run' => time()])->add();
    new TaskInstance()->settingsFromArray(['task' => 'ffUpdateOld', 'arguments' => '[50, "$cronInstance"]', 'instance' => 3, 'enabled' => 1, 'system' => 1, 'frequency' => 60, 'priority' => 0, 'message' => 'Updating old FFXIV entities', 'next_run' => time()])->add();
    new TaskInstance()->settingsFromArray(['task' => 'ffUpdateOld', 'arguments' => '"[50, ""$cronInstance""]"', 'instance' => 4, 'enabled' => 1, 'system' => 1, 'frequency' => 60, 'priority' => 0, 'message' => 'Updating old FFXIV entities', 'next_run' => time()])->add();
    new TaskInstance()->settingsFromArray(['task' => 'ffUpdateOld', 'arguments' => '[50, "$cronInstance"]', 'instance' => 5, 'enabled' => 1, 'system' => 1, 'frequency' => 60, 'priority' => 0, 'message' => 'Updating old FFXIV entities', 'next_run' => time()])->add();
    new TaskInstance()->settingsFromArray(['task' => 'ffUpdateOld', 'arguments' => '[50, "$cronInstance"]', 'instance' => 6, 'enabled' => 1, 'system' => 1, 'frequency' => 60, 'priority' => 0, 'message' => 'Updating old FFXIV entities', 'next_run' => time()])->add();
