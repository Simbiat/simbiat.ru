...
!function () {
    ...
    const bS = (e, t, n, o, r, s) => { let a = 0; const i = [], l = o => { let s = pS([o]); e === hS.Up && (s = s.reverse()); for (let e = 0; e < s.length; e++) {
        ...
        return I.some(ik(e, t)); {
        const o = za(lk);
        return I.from(o.backwards(e, t, dk(e), n)).bind((e => { const o = e.container.data; return uk(e.container, t + o.length, n); }));
    } }, mk = (e, t, n) => { if (!lr(e))
        return I.none(); const o = e.data; if (t <= o.length)
        return I.some(ik(e, t)); {
        const r = za(lk);
        return I.from(r.forwards(e, t, dk(e), n)).bind((e => mk(e.container, t - o.length, n)));
    } }, fk = (e, t, n, o, r) => { const s = za(e, (e => t => e.isBlock(t) || H(["BR", "IMG", "HR", "INPUT"], t.nodeName) || "false" === e.getContentEditable(t))(e)); return I.from(s.backwards(t, n, o, r)); }, gk = e => "" !== e && -1 !== " \xa0\ufeff\f\n\r\t\v".indexOf(e), pk = (e, t) => e.substring(t.length), hk = (e, t, n, o = !1) => { if (!(r = t).collapsed || !lr(r.startContainer))
        return I.none(); var r; const s = { text: "", offset: 0 }, a = e.getParent(t.startContainer, e.isBlock) || e.getRoot(); return fk(e, t.startContainer, t.startOffset, ((e, t, r) => (s.text = r + s.text, s.offset += t, ((e, t, n, o = !1) => { let r; const s = n.charAt(0); for (r = t - 1; r >= 0; r--) {
        const a = e.charAt(r);
        if (!o && gk(a))
            return I.none();
        if (s === a && He(e, n, r, t))
    ...
    const PN = e => { const t = e.ui.registry.getAll().popups, n = he(t, (e => { return (t = e, jk("Autocompleter", xN, t)).fold((e => { throw new Error("Errors: \n" + (e => { const t = e.length > 10 ? e.slice(0, 10).concat([{ path: [], getErrorInfo: N("... (only showing first ten failures)") }]) : e; return V(t, (e => "Failed path: (" + e.path.join(" > ") + ")\n" + e.getErrorInfo())); })((t = e).errors).join("\n") + "\n\nInput object: " + _k(t.input)); var t; }), R); var t; })), o = ke(we(n, (e => e.trigger))), r = Ee(n); return { dataset: n, triggers: o, lookupByTrigger: e => Y(r, (t => t.trigger === e)) }; }, DN = e => { const t = Dr(), n = Br(!1), o = t.isSet, r = () => { o() && ((e => { e.dispatch("AutocompleterEnd"); })(e), n.set(!1), t.clear()); }, s = Le((() => PN(e))), a = a => { (n => t.get().map((t => hk(e.dom, e.selection.getRng(), t.trigger, !0).bind((t => yk(e, s, t, n))))).getOrThunk((() => ((e, t) => { const n = t(), o = e.selection.getRng(); return ((e, t, n) => ue(n.triggers, (n => hk(e, t, n))))(e.dom, o, n).bind((n => yk(e, t, n))); })(e, s))))(a).fold(r, (r => { (e => { o() || t.set({ trigger: e.trigger, matchLength: e.text.length }); })(r.context), r.lookupData.then((o => { t.get().map((s => { const a = r.context; s.trigger === a.trigger && (t.set({ ...s, matchLength: a.text.length }), n.get() ? (Fl(e, { range: a.range }), ((e, t) => { e.dispatch("AutocompleterUpdate", t); })(e, { lookupData: o })) : (n.set(!0), Fl(e, { range: a.range }), ((e, t) => { e.dispatch("AutocompleterStart", t); })(e, { lookupData: o }))); })); })); })); }, i = () => t.get().bind((({ trigger: t }) => { const o = e.selection.getRng(); return hk(e.dom, o, t, n.get()).filter((({ range: e }) => ((e, t) => { const n = e.compareBoundaryPoints(window.Range.START_TO_START, t), o = e.compareBoundaryPoints(window.Range.END_TO_END, t); return n >= 0 && o <= 0; })(o, e))).map((({ range: e }) => e)); })); e.addCommand("mceAutocompleterReload", ((e, t) => { const n = f(t) ? t.fetchOptions : {}; a(n); })), e.addCommand("mceAutocompleterClose", r), e.addCommand("mceAutocompleterRefreshActiveRange", (() => { i().each((t => { Fl(e, { range: t }); })); })), e.editorCommands.addQueryStateHandler("mceAutoCompleterInRange", (() => i().isSome())), ((e, t) => { const n = wa(t.load, 50); e.on("input", (t => { ("insertCompositionText" !== t.inputType || e.composing) && n.throttle(); })), e.on("keydown", (e => { const o = e.which; 8 === o ? n.throttle() : 27 === o ? (n.cancel(), t.cancelIfNecessary()) : 38 !== o && 40 !== o || n.cancel(); }), !0), e.on("remove", n.cancel); })(e, { cancelIfNecessary: r, load: a }); }, LN = xt().browser.isSafari(), MN = e => Ja(Cn(e)), IN = (e, t) => { var n; return 0 === e.startOffset && e.endOffset === (null === (n = t.textContent) || void 0 === n ? void 0 : n.length); }, FN = (e, t) => I.from(e.getParent(t.container(), "details")), UN = (e, t) => FN(e, t).isSome(), zN = (e, t) => { const n = t.getNode(); v(n) || e.selection.setCursorLocation(n, t.offset()); }, jN = (e, t, n) => { const o = e.dom.getParent(t.container(), "details"); if (o && !o.open) {
        ...
        gr(t) ? t.nextSibling && n.isBlock(t.nextSibling) ? (r.setStartBefore(t), r.setEndBefore(t)) : (r.setStartAfter(t), r.setEndAfter(t)) : (r.setStart(t, 0), r.setEnd(t, 0)); e.selection.setRng(r), Vg(e, r); }, JN = (e, t) => { const n = e.getRoot(); let o, r = t; for (; r !== n && r && "false" !== e.getContentEditable(r);) {
        if ("true" === e.getContentEditable(r)) {
            o = r;
            break;
        }
        r = r.parentNode;
    } return r !== n ? o : n; }, eR = e => I.from(e.dom.getParent(e.selection.getStart(!0), e.dom.isBlock)), tR = e => { e.innerHTML = '<br data-mce-bogus="1">'; }, nR = (e, t) => { ed(e).toLowerCase() === t.tagName.toLowerCase() && ((e, t, n) => { const o = e.dom; I.from(n.style).map(o.parseStyle).each((e => { const n = { ...fo(Cn(t)), ...e }; o.setStyles(t, n); })); const r = I.from(n.class).map((e => e.split(/\s+/))), s = I.from(t.className).map((e => Y(e.split(/\s+/), (e => "" !== e)))); It(r, s, ((e, n) => { const r = Y(n, (t => !H(e, t))), s = [...e, ...r]; o.setAttrib(t, "class", s.join(" ")); })); const a = ["style", "class"], i = Ce(n, ((e, t) => !H(a, t))); o.setAttribs(t, i); })(e, t, td(e)); }, oR = (e, t, n, o, r = !0, s, a) => { const i = e.dom, l = e.schema, d = ed(e), c = n ? n.nodeName.toUpperCase() : ""; let u = t; const m = l.getTextInlineElements(); let f; f = s || "TABLE" === c || "HR" === c ? i.create(s || d, a || {}) : n.cloneNode(!1); let g = f; if (r) {
        do {
            if (m[u.nodeName]) {
                if (em(u) || fm(u))
                    continue;
        ...
        i.setAttrib(f, "style", null), i.setAttrib(f, "class", null); return nR(e, f), tR(g), f; }, rR = (e, t) => { const n = null == e ? void 0 : e.parentNode; return C(n) && n.nodeName === t; }, sR = e => C(e) && /^(OL|UL|LI)$/.test(e.nodeName), aR = e => C(e) && /^(LI|DT|DD)$/.test(e.nodeName), iR = e => { const t = e.parentNode; return aR(t) ? t : e; }, lR = (e, t, n) => { let o = e[n ? "firstChild" : "lastChild"]; for (; o && !Jo(o);)
        o = o[n ? "nextSibling" : "previousSibling"]; return o === t; }, dR = e => X(we(fo(Cn(e)), ((e, t) => `${t}: ${e};`)), ((e, t) => e + t), ""), cR = (e, t) => t && "A" === t.nodeName && e.isEmpty(t), uR = (e, t) => e.nodeName === t || e.previousSibling && e.previousSibling.nodeName === t, mR = (e, t) => C(t) && e.isBlock(t) && !/^(TD|TH|CAPTION|FORM)$/.test(t.nodeName) && !/^(fixed|absolute)/i.test(t.style.position) && e.isEditable(t.parentNode) && "false" !== e.getContentEditable(t), fR = (e, t, n) => lr(t) ? e ? 1 === n && t.data.charAt(n - 1) === ei ? 0 : n : n === t.data.length - 1 && t.data.charAt(n) === ei ? t.data.length : n : n, gR = { insert: (e, t) => { let n, o, r, s, a = !1; const i = e.dom, l = e.schema.getNonEmptyElements(), d = e.selection.getRng(), c = ed(e), u = Cn(d.startContainer), f = Fn(u, d.startOffset), g = f.exists((e => Wt(e) && !no(e))), p = d.collapsed && g, b = (t, o) => oR(e, n, _, S, sd(e), t, o), v = e => { const t = fR(e, n, o); if (lr(n) && (e ? t > 0 : t < n.data.length))
            return !1; if ((n.parentNode === _ || n === _) && a && !e)
            return !0; if (e && Jo(n) && n === _.firstChild)
            return !0; if (uR(n, "TABLE") || uR(n, "HR"))
            ...
            if (Jo(s)) {
                ...
                return !1;
            e ? r.prev() : r.next();
        } return !0; }, w = () => { let t; return t = /^(H[1-6]|PRE|FIGURE)$/.test(r) && "HGROUP" !== k ? b(c) : b(), ((e, t) => { const n = ad(e); return !y(t) && (m(n) ? H(Dt.explode(n), t.nodeName.toLowerCase()) : n); })(e, s) && mR(i, s) && i.isEmpty(_, void 0, { includeZwsp: !0 }) ? t = i.split(s, _) : i.insertAfter(t, _), QN(e, t), t; }; Eg(i, d).each((e => { d.setStart(e.startContainer, e.startOffset), d.setEnd(e.endContainer, e.endOffset); })), n = d.startContainer, o = d.startOffset; const E = !(!t || !t.shiftKey), x = !(!t || !t.ctrlKey); Jo(n) && n.hasChildNodes() && !p && (a = o > n.childNodes.length - 1, n = n.childNodes[Math.min(o, n.childNodes.length - 1)] || n, o = a && lr(n) ? n.data.length : 0); const S = JN(i, n); if (!S || ((e, t) => { const n = e.dom.getParent(t, "ol,ul,dl"); return null !== n && "false" === e.dom.getContentEditableParent(n); })(e, n))
            return; E || (n = ((e, t, n, o, r) => { var s, a; const i = e.dom, l = null !== (s = JN(i, o)) && void 0 !== s ? s : i.getRoot(); let d = i.getParent(o, i.isBlock); if (!d || !mR(i, d)) {
            if (d = d || l, !d.hasChildNodes()) {
                const o = i.create(t);
                return nR(e, o), d.appendChild(o), n.setStart(o, 0), n.setEnd(o, 0), o;
            }
            let s, c = o;
            ...
            if (s && u && e.schema.isValidChild(u, t.toLowerCase())) {
                ...
                for (nR(e, l), a.insertBefore(l, s), c = s; c && !i.isBlock(c);) {
            ...
            return ((e, t, n) => { var o, r, s; const a = t(ed(e)), i = ((e, t) => e.dom.getParent(t, xr))(e, n); i && (e.dom.insertAfter(a, i), QN(e, a), (null !== (s = null === (r = null === (o = n.parentElement) || void 0 === o ? void 0 : o.childNodes) || void 0 === r ? void 0 : r.length) && void 0 !== s ? s : 0) > 1 && e.dom.remove(n)); })(e, b, _); if (/^(LI|DT|DD)$/.test(r) && Jo(s) && i.isEmpty(_))
            return void ((e, t, n, o, r) => { const s = e.dom, a = e.selection.getRng(), i = n.parentNode; if (n === e.getBody() || !i)
                return; var l; sR(l = n) && sR(l.parentNode) && (r = "LI"); const d = aR(o) ? dR(o) : void 0; let c = aR(o) && d ? t(r, { style: dR(o) }) : t(r); if (lR(n, o, !0) && lR(n, o, !1))
                if (rR(n, "LI")) {
                    const e = iR(n);
                ...
                rR(n, "LI") ? (s.insertAfter(c, iR(n)), c.appendChild(s.doc.createTextNode(" ")), c.appendChild(n)) : i.insertBefore(c, n), s.remove(o);
            else if (lR(n, o, !1))
                s.insertAfter(c, iR(n)), s.remove(o);
            else {
                n = iR(n);
            ...
            const t = (e => { const t = e.cloneRange(); return t.setStart(e.startContainer, fR(!0, e.startContainer, e.startOffset)), t.setEnd(e.endContainer, fR(!1, e.endContainer, e.endOffset)), t; })(d).cloneRange();
            t.setEndAfter(_);
            ...
            (e => { q(Fo(Cn(e), Yt), (e => { const t = e.dom; t.nodeValue = ni(t.data); })); })(n), (e => { let t = e; do {
                ...
                s = r[a], (!s.hasChildNodes() || s.firstChild === s.lastChild && "" === (null === (o = s.firstChild) || void 0 === o ? void 0 : o.nodeValue) || cR(e, s)) && e.remove(s); })(i, l, R), ((e, t) => { t.normalize(); const n = t.lastChild; (!n || Jo(n) && /^(left|right)$/gi.test(e.getStyle(n, "float", !0))) && e.add(t, "br"); })(i, _), i.isEmpty(_) && tR(_), R.normalize(), i.isEmpty(R) ? (i.remove(R), w()) : (nR(e, R), QN(e, R));
        } i.setAttrib(R, "id", ""), e.dispatch("NewBlock", { newBlock: R }); }, fakeEventName: "insertParagraph" }, pR = (e, t, n) => { const o = e.dom.createRng(); n ? (o.setStartBefore(t), o.setEndBefore(t)) : (o.setStartAfter(t), o.setEndAfter(t)), e.selection.setRng(o), Vg(e, o); }, hR = (e, t) => { const n = vn("br"); po(Cn(t), n), e.undoManager.add(); }, bR = (e, t) => { vR(e.getBody(), t) || ho(Cn(t), vn("br")); const n = vn("br"); ho(Cn(t), n), pR(e, n.dom, !1), e.undoManager.add(); }, vR = (e, t) => { return n = el.after(t), !!gr(n.getNode()) || Gu(e, el.after(t)).map((e => gr(e.getNode()))).getOr(!1); var n; }, yR = e => e && "A" === e.nodeName && "href" in e, CR = e => e.fold(L, yR, yR, L), wR = (e, t) => { t.fold(S, T(hR, e), T(bR, e), S); }, ER = { insert: (e, t) => { const n = (e => { const t = T(Th, e), n = el.fromRangeStart(e.selection.getRng()); return Ux(t, e.getBody(), n).filter(CR); })(e); n.isSome() ? n.each(T(wR, e)) : ((e, t) => { const n = e.selection, o = e.dom, r = n.getRng(); let s, a = !1; Eg(o, r).each((e => { r.setStart(e.startContainer, e.startOffset), r.setEnd(e.endContainer, e.endOffset); })); let i = r.startOffset, l = r.startContainer; if (Jo(l) && l.hasChildNodes()) {
        ...
        if (t.selection.isCollapsed() || (e => { e.execCommand("delete"); })(t), C(n) && KN(t, e.fakeEventName).isDefaultPrevented())
            return;
        e.insert(t, n), C(n) && WN(t, e.fakeEventName);
    } }, IR = (e, t) => { if (e.mode.isReadOnly())
        return; const n = () => MR(ER, e, t), o = () => MR(gR, e, t), r = ((e, t) => Ax([LR([_R], SR.none()), LR([AR(!0), RR], SR.none()), LR([NR("summary", !0)], SR.br()), LR([AR(!0), TR(!1), BR], SR.br()), LR([AR(!0), TR(!1)], SR.block()), LR([AR(!0), TR(!0), BR], SR.block()), LR([AR(!0), TR(!0)], SR.br()), LR([kR(!0), BR], SR.br()), LR([kR(!0)], SR.block()), LR([OR], SR.br()), LR([BR], SR.br()), LR([PR], SR.block()), LR([DR], SR.block())], [e, !(!t || !t.shiftKey)]).getOr(SR.none()))(e, t); switch (nd(e)) {
        case "linebreak":
            r.fold(n, n, S);
            break;
        case "block":
    ...
    const lA = La("mode"), dA = e => t => { t[lA] = e; }, cA = (e, t) => dA(t)(e), uA = dA(0), mA = dA(2), fA = dA(1), gA = e => t => { const n = t; return I.from(n[lA]).exists((t => t === e)); }, pA = gA(0), hA = gA(1), bA = ["none", "copy", "link", "move"], vA = ["none", "copy", "copyLink", "copyMove", "link", "linkMove", "move", "all", "uninitialized"], yA = () => { const e = new window.DataTransfer; let t = "move", n = "all"; const o = { get dropEffect() { return t; }, set dropEffect(e) { H(bA, e) && (t = e); }, get effectAllowed() { return n; }, set effectAllowed(e) { iA(o) && H(vA, e) && (n = e); }, get items() { return ((e, t) => ({ ...t, get length() { return t.length; }, add: (n, o) => { if (pA(e)) {
        ...
        } return t; }, $A = (e, t) => t in e && e[t].length > 0, VA = e => $A(e, "text/html") || $A(e, "text/plain"), qA = (e, t, n) => { const o = "paste" === t.type ? t.clipboardData : t.dataTransfer; var r; if (mc(e) && o) {
        ...
        if (s.length > 0)
            return t.preventDefault(), (r = s, Promise.all(V(r, (e => sy(e).then((t => ({ file: e, uri: t }))))))).then((t => { n && e.selection.setRng(n), q(t, (t => { ((e, t) => { oy(t.uri).each((({ data: n, type: o, base64Encoded: r }) => { const s = r ? n : btoa(n), a = t.file, i = e.editorUpload.blobCache, l = i.getByData(s, o), d = null != l ? l : ((e, t, n, o) => { const r = IA(), s = ld(e) && C(n.name), a = s ? ((e, t) => { const n = t.match(/([\s\S]+?)(?:\.[a-z0-9.]+)$/i); return C(n) ? e.dom.encode(n[1]) : void 0; })(e, n.name) : r, i = s ? n.name : void 0, l = t.create(r, n, o, a, i); return t.add(l), l; })(e, i, a, s); zA(e, `<img src="${d.blobUri()}">`, !1, !0); })); })(e, t); })); })), !0;
    } return !1; }, WA = (e, t, n, o, r) => { let s = OA(n); const a = $A(t, EA()) || _A(n), i = !a && (e => !/<(?:\/?(?!(?:div|p|br|span)>)\w+|(?:(?!(?:span style="white-space:\s?pre;?">)|br\s?\/>))\w+\s[^>]+)>/i.test(e))(s), l = DA(s); (AA(s) || !s.length || i && !l) && (o = !0), (o || l) && (s = $A(t, "text/plain") && i ? t["text/plain"] : (e => { const t = Fs(), n = DC({}, t); let o = ""; const r = t.getVoidElements(), s = Dt.makeMap("script noscript style textarea video audio iframe object", " "), a = t.getBlockElements(), i = e => { const n = e.name, l = e; if ("br" !== n) {
        if ("wbr" !== n)
            if (r[n] && (o += " "), s[n])
                o += " ";
            else {
    ...
    const mT = (e, t) => Math.abs(e.left - t), fT = (e, t) => Math.abs(e.right - t), gT = (e, t) => (e => X(e, ((e, t) => e.fold((() => I.some(t)), (e => { const n = Math.min(t.left, e.left), o = Math.min(t.top, e.top), r = Math.max(t.right, e.right), s = Math.max(t.bottom, e.bottom); return I.some({ top: o, right: r, bottom: s, left: n, width: r - n, height: s - o }); }))), I.none()))(Y(e, (e => { return (n = t) >= (o = e).top && n <= o.bottom; var n, o; }))).fold((() => [[], e]), (t => { const { pass: n, fail: o } = K(e, (e => ((e, t) => { const n = ((e, t) => Math.max(0, Math.min(e.bottom, t.bottom) - Math.max(e.top, t.top)))(e, t) / Math.min(e.height, t.height); return ((e, t) => e.top < t.bottom && e.bottom > t.top)(e, t) && n > .5; })(e, t))); return [n, o]; })), pT = (e, t, n) => t > e.left && t < e.right ? 0 : Math.min(Math.abs(e.left - t), Math.abs(e.right - t)), hT = (e, t, n, o) => { const r = e => Di(e.node) ? I.some(e) : Jo(e.node) ? hT(ce(e.node.childNodes), t, n, !1) : I.none(), s = (e, s) => { const a = ae(e, ((e, o) => s(e, t, n) - s(o, t, n))); return ue(a, r).map((e => o && !lr(e.node) && a.length > 1 ? ((e, o, s) => r(o).filter((o => Math.abs(s(e, t, n) - s(o, t, n)) < 2 && lr(o.node))))(e, a[1], s).getOr(e) : e)); }, [a, i] = gT(pS(e), n), { pass: l, fail: d } = K(i, (e => e.top < n)); return s(a, pT).orThunk((() => s(d, wi))).orThunk((() => s(l, wi))); }, bT = (e, t, n) => ((e, t, n) => { const o = Cn(e), r = Rn(o), s = wn(r, t, n).filter((e => kn(o, e))).getOr(o); return ((e, t, n, o) => { const r = (t, s) => { const a = Y(t.dom.childNodes, O((e => Jo(e) && e.classList.contains("mce-drag-container")))); return s.fold((() => hT(a, n, o, !0)), (e => { const t = Y(a, (t => t !== e.dom)); return hT(t, n, o, !0); })).orThunk((() => (_n(t, e) ? I.none() : On(t)).bind((e => r(e, I.some(t)))))); }; return r(t, I.none()); })(o, s, t, n); })(e, t, n).filter((e => ou(e.node))).map((e => ((e, t) => ({ node: e.node, position: mT(e, t) < fT(e, t) ? uT.Before : uT.After }))(e, t))), vT = e => { var t, n; const o = e.getBoundingClientRect(), r = e.ownerDocument, s = r.documentElement, a = r.defaultView; return { top: o.top + (null !== (t = null == a ? void 0 : a.scrollY) && void 0 !== t ? t : 0) - s.clientTop, left: o.left + (null !== (n = null == a ? void 0 : a.scrollX) && void 0 !== n ? n : 0) - s.clientLeft }; }, yT = e => ({ target: e, srcElement: e }), CT = (e, t, n, o) => { const r = ((e, t) => { const n = (e => { const t = yA(), n = (e => { const t = e; return I.from(t[lA]); })(e); return mA(e), rA(t), t.dropEffect = e.dropEffect, t.effectAllowed = e.effectAllowed, (e => { const t = e; return I.from(t[tA]); })(e).each((e => t.setDragImage(e.image, e.x, e.y))), q(e.types, (n => { "Files" !== n && t.setData(n, e.getData(n)); })), q(e.files, (e => t.items.add(e))), (e => { const t = e; return I.from(t[nA]); })(e).each((e => { ((e, t) => { oA(t)(e); })(t, e); })), n.each((n => { cA(e, n), cA(t, n); })), t; })(e); return "dragstart" === t ? (rA(n), uA(n)) : "drop" === t ? (sA(n), mA(n)) : (aA(n), fA(n)), n; })(n, e); return v(o) ? ((e, t, n) => { const o = B("Function not supported on simulated event."); return { bubbles: !0, cancelBubble: !1, cancelable: !0, composed: !1, currentTarget: null, defaultPrevented: !1, eventPhase: 0, isTrusted: !0, returnValue: !1, timeStamp: 0, type: e, composedPath: o, initEvent: o, preventDefault: S, stopImmediatePropagation: S, stopPropagation: S, AT_TARGET: window.Event.AT_TARGET, BUBBLING_PHASE: window.Event.BUBBLING_PHASE, CAPTURING_PHASE: window.Event.CAPTURING_PHASE, NONE: window.Event.NONE, altKey: !1, button: 0, buttons: 0, clientX: 0, clientY: 0, ctrlKey: !1, layerX: 0, layerY: 0, metaKey: !1, movementX: 0, movementY: 0, offsetX: 0, offsetY: 0, pageX: 0, pageY: 0, relatedTarget: null, screenX: 0, screenY: 0, shiftKey: !1, x: 0, y: 0, detail: 0, view: null, which: 0, initUIEvent: o, initMouseEvent: o, getModifierState: o, dataTransfer: n, ...yT(t) }; })(e, t, r) : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...yT(n) }))(e, o, t, r); }, wT = br, ET = ((...e) => t => { for (let n = 0; n < e.length; n++)
        ...
        const s = r.currentTarget === t.getDoc().documentElement, l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(e, ((e, t) => { return n = (e => e.inline ? vT(e.getBody()) : { left: 0, top: 0 })(e), o = (e => { const t = e.getBody(); return e.inline ? { left: t.scrollLeft, top: t.scrollTop } : { left: 0, top: 0 }; })(e), r = ((e, t) => { if (t.target.ownerDocument !== e.getDoc()) {
            const n = vT(e.getContentAreaContainer()), o = (e => { const t = e.getBody(), n = e.getDoc().documentElement, o = { left: t.scrollLeft, top: t.scrollTop }, r = { left: t.scrollLeft || n.scrollLeft, top: t.scrollTop || n.scrollTop }; return e.inline ? o : r; })(e);
        ...
        if (C(o) && ((e, t, n) => wT(n) && n !== t && e.isEditable(n.parentElement))(t.dom, t.getBody(), o)) {
            ...
            e.set({ element: o, dataTransfer: yA(), dragging: !1, screenX: n.screenX, screenY: n.screenY, maxX: (t.inline ? s.scrollWidth : a.offsetWidth) - 2, maxY: (t.inline ? s.scrollHeight : a.offsetHeight) - 2, relX: n.pageX - r.x, relY: n.pageY - r.y, width: o.offsetWidth, height: o.offsetHeight, ghost: xT(t, o, o.offsetWidth, o.offsetHeight), intervalId: Pr(100) });
        }
    } })(t, e), s = OT(t, e), a = ((e, t) => n => { e.on((e => { var o; if (e.intervalId.clear(), e.dragging) {
        if (((e, t, n) => !y(t) && t !== n && !e.dom.isChildOf(t, n) && e.dom.isEditable(t))(t, (e => { const t = e.getSel(); if (C(t)) {
            ...
            TT(t, "drop", r, e.dataTransfer, n).isDefaultPrevented() || t.undoManager.transact((() => { ((e, t) => { const n = e.getParent(t.parentNode, e.isBlock); AT(t), n && n !== e.getRoot() && e.isEmpty(n) && Ja(Cn(n)); })(t.dom, e.element), (e => { const t = e.getData("text/html"); return "" === t ? I.none() : I.some(t); })(e.dataTransfer).each((e => t.insertContent(e))), t._selectionOverrides.hideFakeCaret(); }));
        }
        ...
        return null;
    } let m = r.startContainer, f = r.startOffset; const g = r.endOffset; if (lr(m) && 0 === f && LT(m.parentNode) && (m = m.parentNode, f = n.nodeIndex(m), m = m.parentNode), !Jo(m))
        ...
        return; g(), p(); const a = MT(e, s); LT(a) ? (r.preventDefault(), JE(e, a).each(f)) : bT(o, r.clientX, r.clientY).each((n => { var o; r.preventDefault(), (o = d(1, n.node, n.position === uT.Before, !1)) && t.setRng(o), er(a) ? a.focus() : e.getBody().focus(); })); })), e.on("keypress", (e => { Qf.modifierPressed(e) || LT(t.getNode()) && e.preventDefault(); })), e.on("GetSelectionRange", (e => { let t = e.range; if (i) {
        if (!i.parentNode)
            return void (i = null);
        t = t.cloneRange(), t.selectNode(i), e.range = t;
    } })), e.on("SetSelectionRange", (e => { e.range = m(e.range); const t = f(e.range, e.forward); t && (e.range = t); })), e.on("AfterSetSelectionRange", (e => { const t = e.range, o = t.startContainer.parentElement; var r; u(t) || Jo(r = o) && "mcepastebin" === r.id || p(), (e => C(e) && n.hasClass(e, "mce-offscreen-selection"))(o) || g(); })), (e => { DT(e), ec(e) && (e => { const t = t => { if (!t.isDefaultPrevented()) {
        ...
        return m.map((e => { const t = ((e, t, n, o = !1) => zT(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(r, s, e, o); return { matches: l.matches.concat([{ pattern: a, startRng: t, endRng: c }]), position: ik(e.startContainer, e.startOffset) }; }));
    } })); }, tO = (e, t, n, o, r, s) => { const a = e.dom; return ck(n, o, a.getRoot()).bind((i => { const l = KT(a, r, n, o); for (let a = 0; a < t.length; a++) {
        const d = t[a];
        if (!Ve(l, d.end))
            continue;
        const c = t.slice();
        ...
        const n = Ol(o(), "enter");
        (n.inlinePatterns.length > 0 || n.blockPatterns.length > 0 || r()) && ((e, t) => ((e, t) => { const n = e.selection.getRng(); return qT(e, n).map((o => { var r; const s = Math.max(0, n.startOffset), a = WT(t, o, null !== (r = o.textContent) && void 0 !== r ? r : ""); return { inlineMatches: oO(e, o, n.startContainer, s, a, !0), blockMatches: uO(e, o, a, !0) }; })).filter((({ inlineMatches: e, blockMatches: t }) => t.length > 0 || e.length > 0)); })(e, t).fold(L, (({ inlineMatches: t, blockMatches: n }) => (e.undoManager.add(), e.undoManager.extra((() => { e.execCommand("mceInsertNewLine"); }), (() => { (e => { e.insertContent(ei, { preserve_zwsp: !0 }); })(e), rO(e, t), ((e, t) => { if (0 === t.length)
            return; const n = e.selection.getBookmark(); q(t, (t => dO(e, t))), e.selection.moveToBookmark(n); })(e, n); const o = e.selection.getRng(), r = ck(o.startContainer, o.startOffset, e.dom.getRoot()); e.execCommand("mceInsertNewLine"), r.each((t => { const n = t.container; n.data.charAt(t.offset - 1) === Vo && (n.deleteData(t.offset - 1, 1), $T(e.dom, n.parentNode, (t => t === e.dom.getRoot()))); })); })), !0))))(e, n) && t.preventDefault();
    } }), !0), e.on("keydown", (t => { if (32 === t.keyCode && e.selection.isCollapsed() && e.selection.isEditable()) {
        const n = Ol(o(), "space");
        (n.blockPatterns.length > 0 || r()) && ((e, t) => ((e, t) => { const n = e.selection.getRng(); return qT(e, n).map((o => { const r = Math.max(0, n.startOffset), s = KT(e.dom, o, n.startContainer, r), a = WT(t, o, s); return gO(e, o, a, !1, s); })).filter((e => e.length > 0)); })(e, t).fold(L, (t => (e.undoManager.transact((() => { ((e, t) => { q(t, (t => mO(e, t))); })(e, t); })), !0))))(e, n) && t.preventDefault();
    } }), !0); const s = () => { if (e.selection.isCollapsed() && e.selection.isEditable()) {
        const t = Ol(o(), "space");
        (t.inlinePatterns.length > 0 || r()) && ((e, t) => { const n = e.selection.getRng(); qT(e, n).map((o => { const r = Math.max(0, n.startOffset - 1), s = KT(e.dom, o, n.startContainer, r), a = WT(t, o, s), i = oO(e, o, n.startContainer, r, a, !1); i.length > 0 && e.undoManager.transact((() => { rO(e, i); })); })); })(e, t);
    ...
    } })); })(e), gw(e) || ((e => { e.on("mousedown", (t => { t.detail >= 3 && (t.preventDefault(), cT(e)); })); })(e), (e => { hO(e); })(e)); const r = JR(e); ((e, t) => { e.addCommand("delete", (() => { ((e, t) => { l_(e, t, !1).fold((() => { e.selection.isEditable() && (Ih(e), jh(e)); }), D); })(e, t); })), e.addCommand("forwardDelete", (() => { ((e, t) => { l_(e, t, !0).fold((() => { e.selection.isEditable() && Fh(e); }), D); })(e, t); })); })(e, r), (e => { e.on("NodeChange", (() => (e => { const t = e.dom, n = e.selection, o = e.schema, r = o.getBlockElements(), s = n.getStart(), a = e.getBody(); let i, l, d = null; const c = ed(e); if (!s || !Jo(s))
        ...
        return t;
    } return t; }, oB = e => { const t = e.split(/\s*,\s*/); return V(t, (e => -1 === e.indexOf(" ") || $e(e, '"') || $e(e, "'") ? e : `'${e}'`)).join(","); }, rB = (e, t) => { if (e.mode.isReadOnly())
        return; const n = e.dom, o = e.selection.getRng(), r = t ? e.selection.getStart() : e.selection.getEnd(), s = t ? o.startContainer : o.endContainer, a = JN(n, s); if (!a || !a.isContentEditable)
        ...
        return; const r = m(o) ? { href: o } : o, s = e.dom.getParent(e.selection.getNode(), "a"); f(r) && m(r.href) && (r.href = r.href.replace(/ /g, "%20"), s && r.href || e.formatter.remove("link"), r.href && e.formatter.apply("link", r, s)); }; e.editorCommands.addCommands({ unlink: () => { if (e.selection.isEditable()) {
            ...
            return ((e, t) => null !== e.dom.getParent(t, (t => "false" === e.dom.getContentEditable(t))))(e, s) || Yf(n), Yf(s), e.hasEditableRoot() || r(e), Kf(e, o), void Zf(e); e.inline || (Tt.browser.isOpera() || Yf(n), e.getWin().focus()), (Tt.browser.isFirefox() || e.inline) && (Yf(n), Kf(e, o)), Zf(e); })(e)); })(e, !0 === o); }, mceToggleVisualAid: () => { e.hasVisual = !e.hasVisual, e.addVisual(); } }); })(e); }, aB = ["toggleview"], iB = e => H(aB, e.toLowerCase());
    class lB {
        ...
        queryCommandState(e) { if (!iB(e) && this.editor.quirks.isHidden() || this.editor.removed)
            return !1; const t = e.toLowerCase(), n = this.commands.state[t]; return !!w(n) && n(t); }
        queryCommandValue(e) { if (!iB(e) && this.editor.quirks.isHidden() || this.editor.removed)
    ...
    class cB {
        static isNative(e) { return !!dB[e.toLowerCase()]; }
    ...
    const uB = e => (e._eventDispatcher || (e._eventDispatcher = new cB({ scope: e, toggleEvent: (t, n) => { cB.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n); } })), e._eventDispatcher), mB = { fire(e, t, n) { return this.dispatch(e, t, n); }, dispatch(e, t, n) { const o = this; if (o.removed && "remove" !== e && "detach" !== e)
            return Xs(e.toLowerCase(), null != t ? t : {}, o); const r = uB(o).dispatch(e, t); if (!1 !== n && o.parent) {
            let t = o.parent();
            for (; t && !r.isPropagationStopped();)
                t.dispatch(e, r, !1), t = t.parent ? t.parent() : void 0;
        } return r; }, on(e, t, n) { return uB(this).on(e, t, n); }, off(e, t) { return uB(this).off(e, t); }, once(e, t) { return uB(this).once(e, t); }, hasEventListeners(e) { return uB(this).has(e); } }, fB = ma.DOM;
    let gB;
    const pB = (e, t) => { if ("selectionchange" === t)
        return e.getDoc(); if (!e.inline && /^(?:mouse|touch|click|contextmenu|drop|dragover|dragend)/.test(t))
        return e.getDoc().documentElement; const n = Td(e); return n ? (e.eventRoot || (e.eventRoot = fB.select(n)[0]), e.eventRoot) : e.getBody(); }, hB = (e, t, n) => { (e => !e.hidden && !iE(e))(e) ? e.dispatch(t, n) : iE(e) && ((e, t) => { if ((e => "click" === e.type)(t) && !Qf.metaKeyPressed(t)) {
        const n = Cn(t.target);
    ...
    } })), e.on("compositionend", (() => { if (xB(e)) {
        const t = e.undoManager.add();
        C(t) && e.undoManager.undo();
    } })); })(e), (e => { (e => { e.serializer ? cE(e) : e.on("PreInit", (() => { cE(e); })); })(e), (e => { e.on("ShowCaret ObjectSelected", (t => { iE(e) && t.preventDefault(); })), e.on("DisabledStateChange", (t => { t.isDefaultPrevented() || dE(e, t.state); })); })(e); })(e), { isReadOnly: () => xB(e), set: o => ((e, t, n, o) => { if (!(o === n.get() || e.initialized && iE(e))) {
            if (!Se(t, o))
                throw new Error(`Editor mode '${o}' is invalid`);
            e.initialized ? _B(e, n, t, o) : e.on("init", (() => _B(e, n, t, o)));
        } })(e, n.get(), t, o), get: () => t.get(), register: (e, t) => { n.set(((e, t, n) => { if (H(SB, t))
    ...
    class BB {
        constructor(e) { this.shortcuts = {}, this.pendingPatterns = [], this.editor = e; const t = this; e.on("keyup keypress keydown", (e => { !t.hasModifier(e) && !t.isFunctionKey(e) || e.isDefaultPrevented() || (NB(t.shortcuts, (n => { t.matchShortcut(e, n) && (t.pendingPatterns = n.subpatterns.slice(0), "keydown" === e.type && t.executeShortcutAction(n)); })), t.matchShortcut(e, t.pendingPatterns[0]) && (1 === t.pendingPatterns.length && "keydown" === e.type && t.executeShortcutAction(t.pendingPatterns[0]), t.pendingPatterns.shift())); })); }
        add(e, t, n, o) { const r = this, s = r.normalizeCommandFunc(n); return NB(RB(Dt.trim(e)), (e => { const n = r.createShortcut(e, t, s, o); r.shortcuts[n.id] = n; })), !0; }
        ...
        createShortcut(e, t, n, o) { const r = Dt.map(RB(e, ">"), OB); return r[r.length - 1] = Dt.extend(r[r.length - 1], { func: n, scope: o || this.editor }), Dt.extend(r[0], { desc: this.editor.translate(t), subpatterns: r.slice(1) }); }
    ...
    class IB {
        constructor(e, t, n) { this.plugins = {}, this.contentCSS = [], this.contentStyles = [], this.loadedCSS = {}, this.isNotDirty = !1, this.composing = !1, this.destroyed = !1, this.hasHiddenInput = !1, this.iframeElement = null, this.initialized = !1, this.readonly = !1, this.removed = !1, this.startContent = "", this._pendingNativeEvents = [], this._skinLoaded = !1, this._editableRoot = !0, this.editorManager = n, this.documentBaseUrl = n.documentBaseURL, LB(this, vB); const o = this; this.id = e, this.hidden = !1; const r = ((e, t) => { const n = Tk(t); return qO(FO || UO, FO, n, e, n); })(n.defaultOptions, t); this.options = ((e, t, n = t) => { const o = {}, r = {}, s = (e, t, n) => { const o = EB(t, n); return wB(o) ? (r[e] = o.value, !0) : (console.warn(CB(`Invalid value passed for the ${e} option`, o)), !1); }, a = e => Se(o, e); return { register: (e, n) => { const a = (e => m(e.processor))(n) ? (e => { const t = (() => { switch (e) {
                ...
                case "string[]": return yB;
                case "object[]": return e => x(e, f);
                case "regexp": return e => u(e, RegExp);
                default: return M;
            } })(); return n => EB(n, t, `The value must be a ${e}.`); })(n.processor) : n.processor, i = ((e, t, n) => { if (!v(t)) {
                const o = EB(t, n);
                if (wB(o))
                    return o.value;
        ...
        show() { const e = this; e.hidden && (e.hidden = !1, e.inline ? e.getBody().contentEditable = "true" : (DB.show(e.getContainer()), DB.hide(e.id)), e.load(), e.dispatch("show")); }
        hide() { const e = this; e.hidden || (e.save(), e.inline ? (e.getBody().contentEditable = "false", e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (DB.hide(e.getContainer()), DB.setStyle(e.id, "display", e.orgDisplay)), e.hidden = !0, e.dispatch("hide")); }
        ...
        save(e = {}) { const t = this; let n = t.getElement(); if (!n || !t.initialized || t.removed)
            ...
            o && MB(o.elements, (e => e.name !== t.id || (e.value = r, !1)));
        ...
        insertContent(e, t) { t && (e = LB({ content: e }, t)), this.execCommand("mceInsertContent", !1, e); }
        ...
        getContainer() { const e = this; return e.container || (e.container = e.editorContainer || DB.get(e.id + "_parent")), e.container; }
        getContentAreaContainer() { return this.contentAreaContainer; }
        getElement() { return this.targetElm || (this.targetElm = DB.get(this.id)), this.targetElm; }
    ...
    const FB = ma.DOM, UB = Dt.each;
    let zB, jB = !1, HB = [];
    const $B = e => { const t = e.type; UB(KB.get(), (n => { switch (t) {
        case "scroll":
        ...
        e ? (t.bind(window, "resize", $B), t.bind(window, "scroll", $B)) : (t.unbind(window, "resize", $B), t.unbind(window, "scroll", $B)), jB = e;
            ...
            return e.preventDefault(), e.returnValue = n.returnValue, n.returnValue; }, window.addEventListener("beforeunload", zB))), e; }, createEditor(e, t) { return this.add(new IB(e, t, this)); }, remove(e) { const t = this; let n; if (e) {
            if (!m(e))
                return n = e, h(t.get(n.id)) ? null : (qB(n) && t.dispatch("RemoveEditor", { editor: n }), 0 === HB.length && window.removeEventListener("beforeunload", zB), n.remove(), VB(HB.length > 0), n);
            UB(FB.select(e), (e => { n = t.get(e.id), n && t.remove(n); }));
        }
        else
            for (let e = HB.length - 1; e >= 0; e--)
                t.remove(HB[e]); }, execCommand(e, t, n) { var o; const r = this, s = f(n) ? null !== (o = n.id) && void 0 !== o ? o : n.index : n; switch (e) {
            case "mceAddEditor":
                if (!r.get(s)) {
                    const e = n.options;
                    new IB(s, e, r).render();
    ...
    try {
        ...
        nP = window.localStorage, nP.setItem(e, e), nP.removeItem(e);
    }
    catch (e) {
        nP = (() => { let e = {}, t = []; const n = { getItem: t => e[t] || null, setItem: (n, o) => { t.push(n), e[n] = String(o); }, key: e => t[e], removeItem: n => { t = t.filter((e => e === n)), delete e[n]; }, clear: () => { t = [], e = {}; }, length: 0 }; return Object.defineProperty(n, "length", { get: () => t.length, configurable: !1, enumerable: !1 }), n; })();
    }
    const oP = { geom: { Rect: eP }, util: { Delay: Uf, Tools: Dt, VK: Qf, URI: CC, EventDispatcher: cB, Observable: mB, I18n: va, LocalStorage: nP, ImageUploader: e => { const t = pE(), n = yE(e, t); return { upload: (t, o = !0) => n.upload(t, o ? vE(e) : void 0) }; } }, dom: { EventUtils: na, TreeWalker: $o, TextSeeker: za, DOMUtils: ma, ScriptLoader: ga, RangeUtils: _g, Serializer: _w, StyleSheetLoader: os, ControlSelection: og, BookmarkManager: yf, Selection: Ew, Event: na.Event }, html: { Styles: Ks, Entities: ws, Node: tp, Schema: Fs, DomParser: DC, Writer: yp, Serializer: Cp }, Env: Tt, AddOnManager: ya, Annotator: vf, Formatter: OE, UndoManager: PE, EditorCommands: lB, WindowManager: Zw, NotificationManager: Yw, EditorObservable: vB, Shortcuts: BB, Editor: IB, FocusManager: Ff, EditorManager: KB, DOM: ma.DOM, ScriptLoader: ga.ScriptLoader, PluginManager: Gw, ThemeManager: Xw, ModelManager: jw, IconManager: zw, Resource: tP, FakeClipboard: YB, trim: Dt.trim, isArray: Dt.isArray, is: Dt.is, toArray: Dt.toArray, makeMap: Dt.makeMap, each: Dt.each, map: Dt.map, grep: Dt.grep, inArray: Dt.inArray, extend: Dt.extend, walk: Dt.walk, resolve: Dt.resolve, explode: Dt.explode, _addCacheSuffix: Dt._addCacheSuffix }, rP = Dt.extend(KB, oP);
    (e => { window.tinymce = e, window.tinyMCE = e; })(rP), (e => { if ("object" == typeof module)
        try {
            module.exports = e;
        }
        catch (e) { } })(rP);
