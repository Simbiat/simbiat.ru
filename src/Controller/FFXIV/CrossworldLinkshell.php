...
final class CrossworldLinkshell extends Page
{
    // Current breadcrumb for navigation
    protected array $breadcrumb = [
        ['href' => '/fftracker/crossworld_linkshells', 'name' => 'Crossworld Linkshell'],
    ];
    ...
    protected function generate(array $path): array
    {
        ...
        $this->alt_links = [
            ['rel' => 'alternate', 'type' => 'application/json', 'title' => 'JSON representation of Tracker data', 'href' => '/api/fftracker/crossworld_linkshells/'.$id],
        ];
        ...
        if (empty($output_array['linkshell']['dates']['deleted'])) {
            $output_array['linkshell']['lodestone_url'] = 'https://eu.finalfantasyxiv.com/lodestone/crossworld_linkshell/'.$id;
            $this->alt_links[] = ['rel' => 'alternate', 'type' => 'application/json', 'title' => 'JSON representation of Lodestone data', 'href' => '/api/fftracker/crossworld_linkshells/'.$id.'/lodestone/'];
