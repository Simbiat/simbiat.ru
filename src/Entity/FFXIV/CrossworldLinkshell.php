    ...
    public function getFromLodestone(bool $allow_sleep = false): string|array
    {
        ...
        if (
            ...
            if (
                ...
                Errors::error_log(new \RuntimeException('Failed to get all necessary data for Crossworld Linkshell '.$this->id), ['last_error' => $lodestone->getLastError(), 'all_errors' => $lodestone->getErrors()]);

                return 'Failed to get all necessary data for Crossworld Linkshell '.$this->id;
            }
